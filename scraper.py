"""
TecSystem Brasil - Robô de Vagas v10.2
========================================
...
ARTIGOS_PADRAO = [
    {"titulo":"A IA vai acabar com o emprego de técnicos industriais?","resumo":"A inteligência artificial está transformando a indústria, mas os dados mostram que técnicos industriais são dos profissionais mais resistentes à automação.","conteudo":"","categoria":"IA & Futuro","icone":"🤖","fonte":"TecSystem Brasil","url":"#","data":datetime.now().strftime("%d/%m/%Y")},
    {"titulo":"Empregos manuais que a IA nunca vai substituir","resumo":"Especialistas apontam que profissões com trabalho físico complexo e raciocínio situacional são as mais seguras diante da automação.","conteudo":"","categoria":"IA & Futuro","icone":"🛡️","fonte":"TecSystem Brasil","url":"#","data":datetime.now().strftime("%d/%m/%Y")},
    {"titulo":"Quanto ganha um Técnico em Manutenção Elétrica em 2026?","resumo":"Salários variam de R$ 2.800 a R$ 6.500. Certificações como NR10 e NR35 podem aumentar em até 30%.","conteudo":"","categoria":"Salários","icone":"⚡","fonte":"TecSystem Brasil","url":"#","data":datetime.now().strftime("%d/%m/%Y")},
    {"titulo":"NR10: Guia Completo para Técnicos Elétricos em 2026","resumo":"A NR10 é obrigatória para trabalhos com instalações elétricas. Curso básico tem 40 horas e validade de 2 anos.","conteudo":"","categoria":"Certificações","icone":"📋","fonte":"TecSystem Brasil","url":"#","data":datetime.now().strftime("%d/%m/%Y")},
    {"titulo":"O técnico industrial que aprender IA vai ganhar o dobro","resumo":"Profissionais que combinam habilidades técnicas com conhecimento em automação e dados recebem propostas 80% acima da média.","conteudo":"","categoria":"IA & Futuro","icone":"🚀","fonte":"TecSystem Brasil","url":"#","data":datetime.now().strftime("%d/%m/%Y")},
    {"titulo":"Melhores empresas para técnicos industriais em 2026","resumo":"Petrobras, Vale, WEG, Embraer e Bosch oferecem os melhores salários e pacotes de benefícios.","conteudo":"","categoria":"Empresas","icone":"🏭","fonte":"TecSystem Brasil","url":"#","data":datetime.now().strftime("%d/%m/%Y")},
]
...
def gerar_card_artigo(a, idx=0):
  ...
  <div class="article-row-body">
    ...
    <p class="article-row-src">{a.get('fonte','TecSystem Brasil')} · {a.get('data','')}</p>
  </div>
...
<div class="modal" id="article-{idx}">
  <div class="modal-box modal-article">
    ...
    <p class="modal-art-meta">{a.get('fonte','TecSystem Brasil')} · {a.get('data','')}</p>
...
<footer>
  <div class="footer-brand">TecSystem<span>.</span>Brasil</div>
...
def main():
    print(f"\n🤖 TecSystem Brasil v10.2 — {datetime.now().strftime('%d/%m/%Y %H:%M')}")
    print("="*50)
