"""
TecSystem Brasil - Robô de Vagas v10.1
========================================
...
2. Allen Bradley (Studio 5000) — forte no setor automotivo
3. Schneider (EcoStruxure) — energia e predial
4. ABB — robótica e motion control
5. Rockwell Automation — indústria pesada
...
• Fique de olho nas vagas aqui no TecSystem Brasil!""",
        "categoria": "Empresas",
        "icone": "🏭",
        "fonte": "TecSystem Brasil",
        "url": "#",
...
2. NR33 — rara, muito valorizada
3. NR35 — muito comum, exigida em quase toda indústria
4. NR12 — importante para manufatura
5. NR13 (vasos de pressão) — específica para utilidades
...
def gerar_card_artigo(a, idx=0):
  ...
  <div class="article-content">
    ...
    <div class="article-footer">
      <span class="article-source">{a.get('fonte','TecSystem Brasil')} · {a.get('data','')}</span>
...
<div class="modal" id="article-{idx}">
  <div class="modal-box modal-article">
    ...
    <div class="modal-article-meta">{a.get('fonte','TecSystem Brasil')} · {a.get('data','')}</div>
...
// NEWSLETTER
function newsletter(){{const e=document.getElementById('nl-e').value;if(!e||!e.includes('@')){{alert('Digite um email válido!');return;}}fetch('https://formsubmit.co/ajax/tecsystembrasil@gmail.com',{{method:'POST',headers:{{'Content-Type':'application/json','Accept':'application/json'}},body:JSON.stringify({{email:e,_subject:'Newsletter TecSystem Brasil'}})}}).catch(()=>{{}});document.getElementById('nl-ok').style.display='block';document.getElementById('nl-e').value='';}}
